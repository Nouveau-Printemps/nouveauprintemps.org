    ...
    render() {
        return html`
            ...
            <g-pib title="Mastodon" color="dark" left img="/icons/brands/mastodon.svg" 
                ...
                <p>
                    Nous avons aussi lancé notre propre instance Mastodon : le Nouveau Printemps Social. 
                    L'annonce est disponible 
                    <a href="https://blog.nouveauprintemps.org/le-reseau-social-du-nouveau-printemps/" target="_blank">
                        ici</a>.
                </p>
            </g-pib>
